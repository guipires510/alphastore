...
export const PRODUCTS: Product[] = [
  {
    ...
    image: PlaceHolderImages.find(img => img.id === 'kit-3-boxer')?.imageUrl || '',
    category: 'kit',
    quantity: 3,
    material: 'Algodão',
  ...
  },
  {
    ...
    image: PlaceHolderImages.find(img => img.id === 'kit-5-boxer')?.imageUrl || '',
    category: 'kit',
    quantity: 5,
    material: 'Microfibra',
  ...
  },
  {
    ...
    description: 'Nossa melhor oferta. 10 cuecas premium para renovar sua gaveta de vez.',
    image: PlaceHolderImages.find(img => img.id === 'kit-10-boxer')?.imageUrl || '',
    category: 'kit',
    quantity: 10,
    material: 'Mista',
  ...
  },
  {
    ...
    image: PlaceHolderImages.find(img => img.id === 'single-brief')?.imageUrl || '',
    category: 'single',
    quantity: 1,
    material: 'Algodão',
